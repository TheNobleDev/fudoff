...
A market-oriented token that is committed to helping remove FUD from the Crypto Space.

$Fudoff features:
4% fee auto added to the liquidity pool and locked
1% fee auto distributed to all hodlers
4% fee added to dev wallet for promotion and devlopment
2% fee added to wallet for buyback $FUDOFF in dip

visit fudoff.net for more information!
...
contract FUDOFF is Context, IERC20, Ownable {
    ...
    uint256 public _liquidityFee = 10;                                                   // % to swap & liquify + wallets
    ...
    uint256 public numTokensSellToAddToLiquidity = _tTotal.div(2000);                    // contract balance to trigger swap & liquify + wallet transfer.
    address public  pancakeRouterAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;   // Pancake Router Version 2 address
    uint[] public _percentages = [67,33];                                                // % of liquidity fee split to wallet(s)
    ...
    constructor () public {
        ...
        //exclude these addresses from receiving reflections straight away.
